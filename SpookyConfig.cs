...
namespace Spooky
{
    public class SpookyConfig : ModConfig
    {
        ...
        + "\nThe halloween seasonal event will still occur during October 10th-31st regardless of this config"
        + "\nYou will need to leave and rejoin the world for this to take effect")]
        [DefaultValue(true)]
