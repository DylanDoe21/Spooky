...
{
	public class CemeteryBiomeChest : ModTile
	{
		public override void SetStaticDefaults() 
		{
            ...
            AddMapEntry(Color.SeaGreen, this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(Color.SeaGreen, this.GetLocalization("MapEntry1"), MapChestName);
		...
		public override bool RightClick(int i, int j) 
		{
			...
			else 
			{
				if (isLocked) 
				{
					int key = ModContent.ItemType<CemeteryKey>();
