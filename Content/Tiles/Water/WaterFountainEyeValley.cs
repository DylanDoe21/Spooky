...
{
    public class WaterFountainEyeValley : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WaterFountainEyeValleyItem>());
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                Main.SceneMetrics.ActiveFountainColor = ModContent.Find<ModWaterStyle>("Spooky/BloodWaterStyle").Slot;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<WaterFountainEyeValleyItem>();
        }
    }
}