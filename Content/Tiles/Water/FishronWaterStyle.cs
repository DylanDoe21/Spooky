...
{
	public class FishronWaterStyle : ModWaterStyle
	{
		public override int ChooseWaterfallStyle() => ModContent.Find<ModWaterfallStyle>("Spooky/FishronWaterfallStyle").Slot;
