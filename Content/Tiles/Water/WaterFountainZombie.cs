...
{
    public class WaterFountainZombie : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WaterFountainZombieItem>());
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                Main.SceneMetrics.ActiveFountainColor = ModContent.Find<ModWaterStyle>("Spooky/ZombieWaterStyle").Slot;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<WaterFountainZombieItem>();
        }
    }
}