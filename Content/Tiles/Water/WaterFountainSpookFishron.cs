...
{
    public class WaterFountainSpookFishron : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WaterFountainSpookFishronItem>());
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                Main.SceneMetrics.ActiveFountainColor = ModContent.Find<ModWaterStyle>("Spooky/FishronWaterStyle").Slot;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<WaterFountainSpookFishronItem>();
        }
    }
}