...
{
    public class WaterFountainSpookFishronXmas : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WaterFountainSpookFishronXmasItem>());
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                Main.SceneMetrics.ActiveFountainColor = ModContent.Find<ModWaterStyle>("Spooky/FishronIceWaterStyle").Slot;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<WaterFountainSpookFishronXmasItem>();
        }
    }
}