...
{
    public class WaterFountainRave : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WaterFountainRaveItem>());
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                Main.SceneMetrics.ActiveFountainColor = ModContent.Find<ModWaterStyle>("Spooky/LeanWaterStyle").Slot;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<WaterFountainRaveItem>();
        }
    }
}