...
namespace Spooky.Content.Tiles.Catacomb
{
	...
	public class CatacombGrass : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(55, 113, 44));
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            if (adjacents.Count > 0)
            {
                ...
                {
                    Framing.GetTileSafely(tilePoint.X, tilePoint.Y).TileType = (ushort)ModContent.TileType<CatacombGrass>();
