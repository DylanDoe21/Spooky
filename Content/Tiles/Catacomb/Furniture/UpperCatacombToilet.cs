...
{
	public class UpperCatacombToilet : ModTile
    {
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(65, 79, 88), Language.GetText("MapObject.Toilet"));
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<UpperCatacombToiletItem>();
