...
{
    public class UpperCatacombDresser : ModTile
    {
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(65, 79, 88), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Catacomb Dresser";
				}
				if (player.cursorItemIconText == "Catacomb Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<UpperCatacombDresserItem>();
