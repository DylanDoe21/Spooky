...
{
	public class UpperCatacombLamp : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(65, 79, 88), Language.GetText("MapObject.FloorLamp"));
            RegisterItemDrop(ModContent.ItemType<UpperCatacombLampItem>());
