...
{
	public class UpperCatacombCandelabra : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(65, 79, 88), Lang.GetItemName(ItemID.Candelabra));
            RegisterItemDrop(ModContent.ItemType<UpperCatacombCandelabraItem>());
