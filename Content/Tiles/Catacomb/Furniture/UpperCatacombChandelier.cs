...
{
	public class UpperCatacombChandelier : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(65, 79, 88), Language.GetText("MapObject.Chandelier"));
        ...
        {
            yield return new Item(ModContent.ItemType<UpperCatacombChandelierItem>());
        }
