...
{
	public class UpperCatacombCandle : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(65, 79, 88), Lang.GetItemName(ItemID.Candle));
            RegisterItemDrop(ModContent.ItemType<UpperCatacombCandleItem>());
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<UpperCatacombCandleItem>();
        }
