...
{
	public class LowerCatacombChandelier : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(86, 46, 29), Language.GetText("MapObject.Chandelier"));
        ...
        {
            yield return new Item(ModContent.ItemType<LowerCatacombChandelierItem>());
        }
