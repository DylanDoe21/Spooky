...
{
	public class UpperCatacombLantern : ModTile
    {
        ...
        public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(65, 79, 88), Language.GetText("MapObject.Lantern"));
            RegisterItemDrop(ModContent.ItemType<UpperCatacombLanternItem>());
