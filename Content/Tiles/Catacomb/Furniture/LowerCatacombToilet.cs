...
{
	public class LowerCatacombToilet : ModTile
    {
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(86, 46, 29), Language.GetText("MapObject.Toilet"));
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<LowerCatacombToiletItem>();
