...
{
	public class LowerCatacombCandle : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(86, 46, 29), Lang.GetItemName(ItemID.Candle));
            RegisterItemDrop(ModContent.ItemType<LowerCatacombCandleItem>());
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<LowerCatacombCandleItem>();
        }
