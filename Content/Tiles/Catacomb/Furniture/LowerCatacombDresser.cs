...
{
    public class LowerCatacombDresser : ModTile
    {
		public override void SetStaticDefaults()
		{
			...
			TileObjectData.addTile(Type);
           	AddMapEntry(new Color(86, 46, 29), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<LowerCatacombDresserItem>();
