...
{
	public class LowerCatacombLamp : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(86, 46, 29), Language.GetText("MapObject.FloorLamp"));
            RegisterItemDrop(ModContent.ItemType<LowerCatacombLampItem>());
