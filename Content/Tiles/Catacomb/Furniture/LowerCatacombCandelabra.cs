...
{
	public class LowerCatacombCandelabra : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(86, 46, 29), Lang.GetItemName(ItemID.Candelabra));
            RegisterItemDrop(ModContent.ItemType<LowerCatacombCandelabraItem>());
