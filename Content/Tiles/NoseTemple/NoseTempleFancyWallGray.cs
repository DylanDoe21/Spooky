...
{  
    public class NoseTempleFancyWallGray : ModWall 
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(28, 19, 27));
        ...
        {
            //wall merges
            MergeTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/NoseTemple/NoseTempleFancyWallMergeGray");
            
            int Type = ModContent.WallType<NoseTempleWallGray>();
    ...
    public class NoseTempleFancyWallGraySafe : NoseTempleFancyWallGray 
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            int Type = ModContent.WallType<NoseTempleWallGraySafe>();
