...
{
	public class OldWoodLantern : ModTile
    {
        ...
        public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(93, 62, 39), Language.GetText("MapObject.Lantern"));
            RegisterItemDrop(ModContent.ItemType<OldWoodLanternItem>());
