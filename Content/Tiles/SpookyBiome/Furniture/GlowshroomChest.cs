...
{
	public class GlowshroomChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<GlowshroomChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<GlowshroomChestItem>();
	...
	public class GlowshroomYellowChest : GlowshroomChest
	{
		public override void SetStaticDefaults()
		{
			Main.tileSpelunker[Type] = true;
			...
			RegisterItemDrop(ModContent.ItemType<GlowshroomYellowChestItem>());
			DustType = DustID.Slush;
			AdjTiles = new int[] { TileID.Containers };
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				if (player.cursorItemIconText == defaultName)
				{
					player.cursorItemIconID = ModContent.ItemType<GlowshroomYellowChestItem>();
					player.cursorItemIconText = string.Empty;
				}
			}
