...
{
	public class OldWoodLamp : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(93, 62, 39), Language.GetText("MapObject.FloorLamp"));
            RegisterItemDrop(ModContent.ItemType<OldWoodLampItem>());
