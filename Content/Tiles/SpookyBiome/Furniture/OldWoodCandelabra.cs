...
{
	public class OldWoodCandelabra : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(93, 62, 39), Lang.GetItemName(ItemID.Candelabra));
            RegisterItemDrop(ModContent.ItemType<OldWoodCandelabraItem>());
