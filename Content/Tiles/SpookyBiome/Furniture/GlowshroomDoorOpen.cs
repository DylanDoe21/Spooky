...
{
    public class GlowshroomDoorOpen : ModTile
    {
		public override void SetStaticDefaults()
		{
            ...
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<GlowshroomDoorClosed>();
	...
	public class GlowshroomYellowDoorOpen : GlowshroomDoorOpen
    {
		public override void SetStaticDefaults()
		{
			Main.tileFrameImportant[Type] = true;
			...
			TileID.Sets.HasOutlines[Type] = true;
			TileID.Sets.DisableSmartCursor[Type] = true;
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<GlowshroomYellowDoorClosed>();
            TileObjectData.newTile.Width = 2;
			TileObjectData.newTile.Height = 3;
			TileObjectData.newTile.Origin = new Point16(0, 0);
			TileObjectData.newTile.DrawYOffset = 0;
