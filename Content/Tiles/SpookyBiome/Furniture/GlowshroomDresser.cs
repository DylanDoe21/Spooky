...
{
    public class GlowshroomDresser : ModTile
    {
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(122, 72, 203), this.GetLocalization("MapEntry"), MapChestName);
	...
	public class GlowshroomYellowDresser : GlowshroomDresser
    {
		public override void SetStaticDefaults()
		{
			Main.tileSolidTop[Type] = true;
			...
			TileObjectData.newTile.AnchorBottom = new AnchorData(AnchorType.SolidTile | AnchorType.SolidWithTop | AnchorType.SolidSide, TileObjectData.newTile.Width, 0);
			TileObjectData.addTile(Type);
            AddMapEntry(new Color(179, 128, 50), this.GetLocalization("MapEntry"), MapChestName);
            DustType = DustID.Slush;
			AddToArray(ref TileID.Sets.RoomNeeds.CountsAsTable);
			AdjTiles = new int[] { TileID.Dressers };
		}
