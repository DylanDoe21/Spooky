...
namespace Spooky.Content.Tiles.SpookyBiome.Furniture
{
	public class SpookyBiomeChest : ModTile
	{
		public override void SetStaticDefaults() 
		{
			...
			ContainerName.SetDefault("Spooky Pumpkin Chest");
			ModTranslation name = CreateMapEntryName();
			name.SetDefault("Spooky Pumpkin Chest");
			AddMapEntry(new Color(140, 99, 201), name, MapChestName);
			name = CreateMapEntryName(Name + "_Locked"); // With multiple map entries, you need unique translation keys.
			name.SetDefault("Locked Spooky Pumpkin Chest");
			AddMapEntry(new Color(140, 99, 201), name, MapChestName);
		...
		public override void MouseOver(int i, int j) 
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Spooky Pumpkin Chest";
				if (player.cursorItemIconText == "Spooky Pumpkin Chest") 
				{
