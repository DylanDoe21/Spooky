...
{
    public class OldWoodDresser : ModTile
    {
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(93, 62, 39), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<OldWoodDresserItem>();
