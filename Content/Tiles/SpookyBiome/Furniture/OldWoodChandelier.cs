...
{
	public class OldWoodChandelier : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(93, 62, 39), Language.GetText("MapObject.Chandelier"));
        ...
        {
            yield return new Item(ModContent.ItemType<OldWoodChandelierItem>());
        }
