...
{
    public class GourdLarge : ModTile
    {
    ...
    public class GourdLargeCarved : GourdLarge
    {
        public override void SetStaticDefaults()
        {
            Main.tileSolid[Type] = false;
    ...
    public class GourdLargeCarvedLit : GourdLargeCarved
    {
        public override string Texture => "Spooky/Content/Tiles/SpookyBiome/Ambient/GourdLargeCarved";
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch) 
		{
            ...
            Texture2D flameTexture = ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyBiome/Ambient/GourdLargeCarvedGlow").Value;
