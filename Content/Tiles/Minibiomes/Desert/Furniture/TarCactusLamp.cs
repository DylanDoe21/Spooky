...
{
	public class TarCactusLamp : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(57, 100, 56), Language.GetText("MapObject.FloorLamp"));
            RegisterItemDrop(ModContent.ItemType<TarCactusLampItem>());
