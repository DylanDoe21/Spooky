...
{
    public class TarCactusDresser : ModTile
    {
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(57, 100, 56), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<TarCactusDresserItem>();
