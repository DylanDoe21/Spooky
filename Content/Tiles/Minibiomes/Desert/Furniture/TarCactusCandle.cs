...
{
	public class TarCactusCandle : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(57, 100, 56), Lang.GetItemName(ItemID.Candle));
            RegisterItemDrop(ModContent.ItemType<TarCactusCandleItem>());
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<TarCactusCandleItem>();
        }
