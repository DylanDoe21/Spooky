...
{
	public class TarCactusChest : ModTile
	{
		public sealed override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(57, 100, 56), name);
			RegisterItemDrop(ModContent.ItemType<TarCactusChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<TarCactusChestItem>();
