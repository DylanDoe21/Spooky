...
{
	public class TarCactusCandelabra : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(57, 100, 56), Lang.GetItemName(ItemID.Candelabra));
            RegisterItemDrop(ModContent.ItemType<TarCactusCandelabraItem>());
