...
{
	public class TarCactusLantern : ModTile
    {
        ...
        public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(57, 100, 56), Language.GetText("MapObject.Lantern"));
            RegisterItemDrop(ModContent.ItemType<TarCactusLanternItem>());
