...
{
	public class TarCactusChandelier : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(57, 100, 56), Language.GetText("MapObject.Chandelier"));
        ...
        {
            yield return new Item(ModContent.ItemType<TarCactusChandelierItem>());
        }
