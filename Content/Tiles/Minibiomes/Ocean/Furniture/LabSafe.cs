...
namespace Spooky.Content.Tiles.Minibiomes.Ocean.Furniture
{
	public class LabSafe : ModTile
	{
		public sealed override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(156, 154, 121), name);
			RegisterItemDrop(ModContent.ItemType<LabSafeItem>());
			DustType = -1;
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<LabSafeItem>();
