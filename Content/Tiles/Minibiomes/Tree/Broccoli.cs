...
namespace Spooky.Content.Tiles.Minibiomes.Tree
{
    public class Broccoli : ModTile
    {
        ...
        {
			TopTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/Minibiomes/Tree/BroccoliTop");
			BranchTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/Minibiomes/Tree/BroccoliBranches");
