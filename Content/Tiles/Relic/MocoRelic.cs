...
{
	public class MocoRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Spooky/Content/Tiles/Relic/MocoRelic";
        ...
        {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, ModContent.ItemType<MocoRelicItem>());
		}
