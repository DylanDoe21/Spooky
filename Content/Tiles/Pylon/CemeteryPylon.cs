...
namespace Spooky.Content.Tiles.Pylon
{
	public class CemeteryPylon : ModPylon
	{
		...
		public override void SetStaticDefaults() 
        {
            ...
            name.SetDefault("Swampy Cemetery Pylon");
		...
		public override int? IsPylonForSale(int npcType, Player player, bool isNPCHappyEnough) 
        {
			...
			return ModContent.GetInstance<Biomes.CemeteryBiome>().IsBiomeActive(player) && isNPCHappyEnough ? ModContent.ItemType<CemeteryPylonItem>() : null;
		}
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) 
        {
			...
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<CemeteryPylonItem>());
		}
		...
		public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale) 
        {
			...
			DefaultMapClickHandle(mouseOver, pylonInfo, "Mods.Spooky.ItemName.CemeteryPylonItem", ref mouseOverText);
		}
	}
}