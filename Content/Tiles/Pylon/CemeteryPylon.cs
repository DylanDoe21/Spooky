...
namespace Spooky.Content.Tiles.Pylon
{
    ...
    {
        public static Condition InBiome = new Condition("Mods.Spooky.Conditions.InBiome", () => Main.LocalPlayer.InModBiome<CemeteryBiome>());
    }
    ...
    public class CemeteryPylon : ModPylon
	{
        ...
        {
            return new NPCShop.Entry(ModContent.ItemType<CemeteryPylonItem>(), Condition.HappyEnoughToSellPylons, CemeteryCondition.InBiome);
        }
