...
{
    public class SpookyBiomeUGBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SpookyBiomeUGBox>();
        }
		...
		{
            Texture2D flameTexture = ModContent.Request<Texture2D>("Spooky/Content/Tiles/MusicBox/SpookyBiomeUGBoxTileGlow").Value;
