...
{
    public class RaveyardPurpleBoxTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<RaveyardPurpleBox>();
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
		{
            ...
            {
                r = Color.Purple.R / 450f;
                g = Color.Purple.G / 450f;
                b = Color.Purple.B / 450f;
            }
        }
