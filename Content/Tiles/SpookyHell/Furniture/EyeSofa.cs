...
namespace Spooky.Content.Tiles.SpookyHell.Furniture
{
	public class EyeSofa : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), new Vector2(i, j) * 16f, ModContent.ItemType<EyeSofaItem>());
		}

		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            Tile tile = Framing.GetTileSafely(i, j);
			Texture2D tex = ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyHell/Furniture/EyeSofaGlow").Value;
