...
{
	public class SpookyHellTorchItem : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<SpookyHellTorch>());
            Item.width = 16;
			Item.height = 16;
			Item.holdStyle = 1;
			Item.flame = true;
		...
		public override void HoldItem(Player player)
		{
			if (!player.wet)
			{
				...
				float divide = 300f;
				Lighting.AddLight(position, new Vector3(255f / divide, 68f / divide, 105f / divide));
			}
		}
		...
		public override void PostUpdate()
		{
			...
			{
				float divide = 300f;
				Lighting.AddLight(Item.Center, new Vector3(255f / divide, 68f / divide, 105f / divide));
			}
		}
