...
{
    public class EyeDresser : ModTile
    {
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<EyeDresserItem>());
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Living Flesh Dresser";
				}
				if (player.cursorItemIconText == "Living Flesh Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<EyeDresserItem>();
