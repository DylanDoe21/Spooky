...
namespace Spooky.Content.Tiles.SpookyHell.Ambient
{
    public class EyeStalkMedium1 : ModTile
    {
        ...
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyHell/Ambient/EyeStalkMedium1Glow");
	...
	public class EyeStalkMedium2 : EyeStalkMedium1
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyHell/Ambient/EyeStalkMedium2Glow");
