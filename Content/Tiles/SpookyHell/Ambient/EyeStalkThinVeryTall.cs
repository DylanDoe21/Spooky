...
namespace Spooky.Content.Tiles.SpookyHell.Ambient
{
	...
	[LegacyName("StalkPurple3")]
	[LegacyName("StalkRed3")]
	public class EyeStalkThinVeryTall : ModTile
	{
        ...
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyHell/Ambient/EyeStalkThinVeryTallGlow");
