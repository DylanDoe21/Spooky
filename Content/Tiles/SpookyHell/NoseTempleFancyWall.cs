...
{
    public class NoseTempleFancyWall : ModWall 
    {
        public override void SetStaticDefaults()
        {
            Main.wallHouse[Type] = false;
            AddMapEntry(new Color(24, 19, 27));
        ...
        {
            //wall merges
            Texture2D mergeTex = ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpookyHell/NoseTempleFancyWallMerge").Value;
            
            int Type = ModContent.WallType<NoseTempleWall>();
