...
namespace Spooky.Content.Tiles.SpiderCave.Ambient
{
    public class GnomeHouse1 : ModTile
    {
        ...
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Ambient/GnomeHouse1Glow");
    ...
    public class GnomeHouse2 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Ambient/GnomeHouse2Glow");
    ...
    public class GnomeHouse3 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Ambient/GnomeHouse3Glow");
    ...
    public class GnomeHouse4 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Ambient/GnomeHouse4Glow");
