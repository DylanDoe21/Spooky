...
{
	public class BirchChandelier : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			AddMapEntry(new Color(155, 153, 153), Language.GetText("MapObject.Chandelier"));
            DustType = DustID.Web;
        ...
        {
            yield return new Item(ModContent.ItemType<BirchChandelierItem>());
        }
