...
{
	public class BirchCandelabra : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(155, 153, 153), Lang.GetItemName(ItemID.Candelabra));
            RegisterItemDrop(ModContent.ItemType<BirchCandelabraItem>());
            DustType = DustID.Web;
