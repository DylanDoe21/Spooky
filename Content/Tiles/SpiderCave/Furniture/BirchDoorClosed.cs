...
{
    public class BirchDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(155, 153, 153), Language.GetText("MapObject.Door"));
            DustType = DustID.Web;
        ...
        {
            yield return new Item(ModContent.ItemType<BirchDoorItem>());
        }
