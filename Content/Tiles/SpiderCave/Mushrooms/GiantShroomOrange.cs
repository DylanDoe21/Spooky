...
{
    public class GiantShroomOrange1 : ModTile
    {
        ...
        {
            Texture2D capTex = ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Mushrooms/GiantShroomOrange1Cap").Value;
    ...
    public class GiantShroomOrange2 : GiantShroomOrange1
    {
        public override void SetStaticDefaults()
        {
            Main.tileSolid[Type] = false;
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            Texture2D capTex = ModContent.Request<Texture2D>("Spooky/Content/Tiles/SpiderCave/Mushrooms/GiantShroomOrange2Cap").Value;
