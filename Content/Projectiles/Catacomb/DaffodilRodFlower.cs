...
namespace Spooky.Content.Projectiles.Catacomb
{
	public class DaffodilRodFlower : ModProjectile
	{
        ...
        {
            trail = trail ?? new Trail(Main.instance.GraphicsDevice, TrailLength, new TriangularTip(4), factor => 7 * factor, factor =>
            {
                return Color.Lerp(Color.Brown, Color.Gold, factor.X) * factor.X;
            });
