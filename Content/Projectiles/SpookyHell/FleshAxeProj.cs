...
{
    public class FleshAxeProj : ModProjectile
    {
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			SlashTexture ??= ModContent.Request<Texture2D>("Spooky/Content/Projectiles/SpookyHell/FleshAxeProjSlash");
			...
			if (flip)
			{
				...
				Main.spriteBatch.Draw(SlashTexture.Value, player.MountedCenter - Main.screenPosition, null, Color.Red * SlashAlpha, rotation + 1.57f, new Vector2(SlashTexture.Width() / 2, SlashTexture.Height()), Projectile.scale, SpriteEffects.FlipHorizontally, 0f);
			}
			else
			{
				...
				Main.spriteBatch.Draw(SlashTexture.Value, player.MountedCenter - Main.screenPosition, null, Color.Red * SlashAlpha, rotation + 1.57f, new Vector2(SlashTexture.Width() / 2, SlashTexture.Height()), Projectile.scale, SpriteEffects.None, 0f);
			}
