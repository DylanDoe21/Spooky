...
namespace Spooky.Content.Projectiles.SpookyHell
{
	...
	public class EyeFlailProj : ModProjectile
	{
		...
		private const string ChainTextureExtraPath = "Spooky/Content/Projectiles/SpookyHell/EyeFlailChain";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI() 
        {
			...
			int launchTimeLimit = 12; // was 15  // How much time the projectile can go before retracting (speed and shootTimer will set the flail's range)
			float launchSpeed = 22f; //was 14f // How fast the projectile can move
