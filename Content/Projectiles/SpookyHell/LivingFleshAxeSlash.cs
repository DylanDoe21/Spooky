...
{ 
    public class LivingFleshAxeSlash : SwordSlashBase
    {
        ...
        {
            float coneLength2 = 58f * Projectile.scale;
        ...
        public void DrawSlash(Projectile proj, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(Texture.Value, vector, rectangle, Color.Blue * Fade * 0.75f, proj.rotation, origin, 1.5f, effects, 0f);
            Main.spriteBatch.Draw(Texture.Value, vector, rectangle, Color.Crimson * Fade * 0.75f, proj.rotation, origin, 0.75f, effects, 0f);

            //additional slash lines drawn on top of the main slash effect
            Main.spriteBatch.Draw(Texture.Value, vector, Texture.Frame(1, 2, 0, 1), Color.Gray * Fade * 0.75f, proj.rotation, origin, 1.5f, effects, 0f);
            Main.spriteBatch.Draw(Texture.Value, vector, Texture.Frame(1, 2, 0, 1), Color.Gray * Fade * 0.75f, proj.rotation, origin, 0.75f, effects, 0f);
        }
