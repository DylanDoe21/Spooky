...
{
    public class LongisquamaPet : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(1, 5, 4)
        ...
        public override void AI()
        {
			...
			if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().LongisquamaPet = false;
            }

			if (player.GetModPlayer<SpookyPlayer>().LongisquamaPet)
            {
				Projectile.timeLeft = 2;
            }
