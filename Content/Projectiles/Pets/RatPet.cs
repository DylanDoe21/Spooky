...
{
    public class RatPet : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, 5, 5)
        ...
        public override void AI()
        {
			...
			if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().RatPet = false;
            }

			if (player.GetModPlayer<SpookyPlayer>().RatPet)
            {
				Projectile.timeLeft = 2;
            }
