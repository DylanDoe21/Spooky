...
{
    public class SludgePet : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, 1, 4)
        ...
        public override void AI()
        {
			...
			if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().SludgePet = false;
            }

			if (player.GetModPlayer<SpookyPlayer>().SludgePet)
            {
				Projectile.timeLeft = 2;
            }
