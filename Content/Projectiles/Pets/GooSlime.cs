...
{
    public class GooSlime : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, 3, 5)
            .WithOffset(-5f, 0f).WithSpriteDirection(-1).WhenNotSelected(0, 0);
        }
        ...
        public override void AI()
        {
			...
			if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().GooSlimePet = false;
            }
