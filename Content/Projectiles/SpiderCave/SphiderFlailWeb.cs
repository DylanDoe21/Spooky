...
{
    public class SphiderFlailWeb : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
		{
			...
			{                                                                                  
				int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Web, 0f, -2f, 0, default, 0.85f);
