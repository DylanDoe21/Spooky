...
{
	public class OpalSlingshotProj : SlingshotBaseProj
	{
		...
		public override void AI()
		{
			...
			else
			{
				...
				if (Projectile.timeLeft == 39 || Projectile.timeLeft == 29 || Projectile.timeLeft == 19)
				{
					...
					int Type = GetProjectileToShoot(player, ModContent.ProjectileType<OpalSlingshotBone>());
					...
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.knockBack, Projectile.owner, ai1: Main.rand.Next(0, 3));
					}
				}
