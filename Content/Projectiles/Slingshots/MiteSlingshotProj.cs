...
{
	public class MiteSlingshotProj : SlingshotBaseProj
	{
		...
		public override void AI()
		{
			...
			else
			{
				...
				if (Projectile.timeLeft >= 19)
				{
					...
					int Type = GetProjectileToShoot(player, ModContent.ProjectileType<SlingshotMite>());
					...
					if (Projectile.owner == Main.myPlayer)
					{
						...
						int newProj = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, ShootSpeed, Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
						if (Type == ModContent.ProjectileType<SlingshotMite>())
						{
							Main.projectile[newProj].ai[0] = Main.rand.Next(0, 8);
						}
					}
				}
