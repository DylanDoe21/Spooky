...
{
	public class PepperFlame : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color1 = new Color(237, 178, 155, 200);
			Color color2 = new Color(223, 104, 71, 70);
			Color color3 = new Color(201, 34, 32, 100);
		...
		{
			//the npc that spawns the flame should take half damage from it so it doesnt die immediately, allowing it to shoot flames at other enemies more
