...
namespace Spooky.Content.Projectiles.Minibiomes.Ocean
{
    public class ZombieEelBody : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Vector2 drawOrigin = new(ProjTexture.Width() * 0.5f, (ProjTexture.Height() / 7) * 0.5f);
        ...
        public override void AI()
        {
			...
			{
				Projectile.Center = SegmentParent.Center - SegmentCenter.SafeNormalize(Vector2.Zero) * 42f;
			}
        }
    }
}
