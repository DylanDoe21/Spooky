...
namespace Spooky.Content.Backgrounds.SpookyHell
{
	public class SpookyHellMenuBG : ModSurfaceBackgroundStyle
	{
        ...
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
			...
			{
                BackgroundTextureLoader.GetBackgroundSlot("Spooky/Content/Backgrounds/SpookyHell/SpookyHellBG5"),
                BackgroundTextureLoader.GetBackgroundSlot("Spooky/Content/Backgrounds/SpookyHell/SpookyHellBG2"),
                BackgroundTextureLoader.GetBackgroundSlot("Spooky/Content/Backgrounds/SpookyHell/SpookyHellBG1"),
				BackgroundTextureLoader.GetBackgroundSlot("Spooky/Content/Backgrounds/SpookyHell/SpookyHellBG0"),
            };
