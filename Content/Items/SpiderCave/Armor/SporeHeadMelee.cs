...
namespace Spooky.Content.Items.SpiderCave.Armor
{
	...
	public class SporeHeadMelee : ModItem
	{
		...
		{
			//player.setBonus = Language.GetTextValue("Mods.Spooky.ArmorSetBonus.SporeArmorMelee");
			//player.GetModPlayer<SpookyPlayer>().SporeMeleeSet = true;
		}
