...
{
    public class SpearfishLanceMetal : ModItem
    {
        ...
        public override void UseAnimation(Player player)
		{
			if (player.altFunctionUse == 2)
			{
                ...
                Item.shoot = ModContent.ProjectileType<SpearfishLanceMetalSlashProj>();
            }
			else
			{
                Item.UseSound = SoundID.Item7;
        ...
        {
            return player.ownedProjectileCounts[ModContent.ProjectileType<SpearfishLanceMetalProj>()] < 1 && player.ownedProjectileCounts[ModContent.ProjectileType<SpearfishLanceMetalSlashProj>()] < 1;
        }
