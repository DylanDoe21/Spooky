...
{
	public class FungusInkCap : ModItem
	{
        ...
        {
            return player.GetModPlayer<BloomBuffsPlayer>().CanConsumeFruit("FungusInkCap");
        }

		public override bool? UseItem(Player player)
		{
			player.GetModPlayer<BloomBuffsPlayer>().AddBuffToList("FungusInkCap", 10800);
