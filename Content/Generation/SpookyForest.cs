...
namespace Spooky.Content.Generation
{
    public class SpookyForest : ModSystem
    {
        ...
        public void GenerateStarterHouse(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            while (!placed && attempts++ < 100000)
            {
                ...
                if (Main.tile[x, y].HasTile)
				{
                    ...
                    NPC.NewNPC(null, x * 16, (y - 6) * 16, ModContent.NPCType<LittleBoneSleeping>(), 0, 0f, 0f, 0f, 0f, 255);
        ...
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
		{
            ...
            tasks.Insert(GenIndex1 + 2, new PassLegacy("SpookyLoot", GenerateUndergroundCabins));
