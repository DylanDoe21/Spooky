...
{
    public class GiantBiomassPurple : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
		{
            ...
            {
                int DustGore = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<SmokeEffect>(), 0f, 0f, 100, Color.Purple * 0.65f, Main.rand.NextFloat(1f, 1.2f));
