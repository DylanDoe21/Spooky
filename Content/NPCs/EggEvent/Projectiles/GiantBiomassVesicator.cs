    ...
    public class GiantBiomassVesicator : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Projectile.ai[0] == 1 && Projectile.localAI[1] >= 60)
            {
                ...
                Texture2D tex = ModContent.Request<Texture2D>("Spooky/Content/NPCs/EggEvent/Projectiles/GiantBiomassVesicatorAura").Value;
                ...
                Main.EntitySpriteDraw(tex, vector, rectangle, newColor, Projectile.rotation, drawOrigin, Projectile.localAI[2] / 37 + (Projectile.localAI[2] < 320 ? time : time2), SpriteEffects.None, 0);
            }
