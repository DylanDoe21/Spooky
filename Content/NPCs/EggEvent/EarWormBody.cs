...
namespace Spooky.Content.NPCs.EggEvent
{
    public class EarWormBody : ModNPC
    {
		...
		public override bool PreAI()
        {
			...
			if (NPC.ai[1] < (double)Main.npc.Length)
            {
                ...
                float dirX = Parent.position.X + (float)(Parent.width / 2) - npcCenter.X;
                float dirY = Parent.position.Y + (float)(Parent.height / 2) - npcCenter.Y;
    ...
    public class EarWormBodyEye1 : EarWormBody
    {
        private static Asset<Texture2D> NPCTexture;
        ...
        {
			NPCTexture ??= ModContent.Request<Texture2D>(Texture);
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/NPCs/EggEvent/EarWormBodyEye1Glow");
    ...
    public class EarWormBodyEye2 : EarWormBodyEye1
    {
		private static Asset<Texture2D> NPCTexture;
        private static Asset<Texture2D> GlowTexture;
        ...
        {
			NPCTexture ??= ModContent.Request<Texture2D>(Texture);
            GlowTexture ??= ModContent.Request<Texture2D>("Spooky/Content/NPCs/EggEvent/EarWormBodyEye2Glow");
    ...
    public class EarWormTail : EarWormBody
    {
        private static Asset<Texture2D> NPCTexture;
