...
{
	public class MortarFire : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color2 = color1;
			Color color3 = new Color(Color.Gold.R, Color.Gold.G, Color.Gold.B, 70);
			Color color4 = new Color(Color.Orange.R, Color.Orange.G, Color.Orange.B, 100);
