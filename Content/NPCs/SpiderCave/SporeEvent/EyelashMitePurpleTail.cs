...
{
    public class EyelashMitePurpleTail : ModNPC
    {
        ...
        public override bool PreAI()
        {
			...
			if (!Parent.active || Parent.type != ModContent.NPCType<EyelashMitePurpleHead>())
            {
                ...
                {
                    Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModContent.Find<ModGore>("Spooky/EyelashMitePurpleTailGore").Type);
                }
