...
namespace Spooky.Content.NPCs.Boss.SpookySpirit.Projectiles
{
    public class EyeBeam : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            new Vector2(1f, 0).RotatedBy(Projectile.rotation) * LaserScale, -1.57f, LaserScale, LaserLength, Color.White * 0.75f, (int)FirstSegmentDrawDist);
        ...
        public override void AI()
        {
            ...
            if (!Parent.active || (Parent.type != ModContent.NPCType<SpookySpirit>()))
            {
                Projectile.Kill();
            }
        ...
        {
            Vector2 unit = new Vector2(0.9f, 0).RotatedBy(Projectile.rotation);
            float point = 0f;
