    ...
    public class OrroTail : ModNPC
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                {
                    Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, ModContent.Find<ModGore>("Spooky/TailGore1").Type);
                    Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, ModContent.Find<ModGore>("Spooky/TailGore2").Type);
