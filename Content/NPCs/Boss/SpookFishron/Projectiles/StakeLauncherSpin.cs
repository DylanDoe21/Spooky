...
{
    public class StakeLauncherSpin : ModProjectile
    {
        public override string Texture => "Spooky/Content/NPCs/Boss/SpookFishron/Projectiles/StakeLauncher";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int oldPos = 0; oldPos < Projectile.oldPos.Length; oldPos++)
            {
                ...
                Color color = Projectile.GetAlpha(Color.OrangeRed) * ((Projectile.oldPos.Length - oldPos) / (float)Projectile.oldPos.Length) * 0.65f;
		...
		public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                if (Projectile.Hitbox.Intersects(collision))
                {
                    ...
                    ModContent.ProjectileType<StakeLauncher>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[1]);
