...
{
    public class PartySkeleton3 : ModNPC  
    {
        bool hasDrink = false;
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if (hasDrink)
            {
                Texture2D tex = ModContent.Request<Texture2D>("Spooky/Content/NPCs/Friendly/PartySkeleton3Cup").Value;
        ...
        public override string GetChat()
		{
			...
			{
                "Whooaaaaa man, you look super goofy! You definitely aren't the same as us, but you are welcome to stay and parrrrty!",
				"Im feel...ling... super sleepy... maybe drinking so much... of that creepy glowing soda wasn't... a good idea."
			};
        ...
        public override void AI()
		{
            ...
            if (NPC.localAI[0] == 1)
            {
                string[] names = { "McRibb ", "Fibula", "Mike" };
