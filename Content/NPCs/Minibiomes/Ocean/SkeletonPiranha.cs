...
{
	public class SkeletonPiranha : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			{
				new FlavorTextBestiaryInfoElement("Mods.Spooky.Bestiary.SkeletonPiranha"),
		...
		public override void AI()
		{
			...
			SkeletonFish.FishSwimmingAI(NPC, SavePosition, 200, 170, 3f, 3f, 0.018f, 0.05f);
		}
        ...
        public override void HitEffect(NPC.HitInfo hit) 
        {
            if (NPC.life <= 0) 
            {
                for (int numGores = 1; numGores <= 5; numGores++)
                {
                    ...
                    {
                        Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModContent.Find<ModGore>("Spooky/SkeletonPiranhaGore" + numGores).Type);
                    }
                }
            }
        }
