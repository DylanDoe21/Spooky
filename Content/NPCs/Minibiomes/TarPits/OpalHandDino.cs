...
namespace Spooky.Content.NPCs.Minibiomes.TarPits
{
    public class OpalHandDino : ModNPC  
    {
		...
		{
			ArmFrontTexture ??= ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/OpalHandDinoArmFront");
            ArmBackTexture ??= ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/OpalHandDinoArmBack");
