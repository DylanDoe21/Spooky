	...
	public class OpalTarCrawler : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			if (legs != null)
			{
				...
				legs[0].Draw(ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/BackLegTop1"),
				ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/BackLegTop2"),
				24, 54, NPC.Center, NPC.rotation, spriteBatch);

				legs[1].Draw(ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/FrontLegTop1"),
				ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/FrontLegTop2"),
				26, 54, NPC.Center, NPC.rotation, spriteBatch);

				legs[2].Draw(ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/BackLegBottom1"),
				ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/BackLegBottom2"),
				42, 54, NPC.Center, NPC.rotation, spriteBatch);

				legs[3].Draw(ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/FrontLegBottom1"), 
				ModContent.Request<Texture2D>("Spooky/Content/NPCs/Minibiomes/TarPits/CrawlerLegs/FrontLegBottom2"),
