        ...
        public override void AI()
		{
            ...
            if (NPC.ai[0] >= 480)
            {
                ...
                if (NPC.ai[1] > 110)
                {
                    ...
                    NPCGlobalHelper.ShootHostileProjectile(NPC, new Vector2(NPC.Center.X, NPC.Center.Y + 6), new Vector2(ShootSpeedX, -5), ModContent.ProjectileType<NoseCultistMageSnot>(), 0, 0f);
