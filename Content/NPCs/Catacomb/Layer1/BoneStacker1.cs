...
namespace Spooky.Content.NPCs.Catacomb.Layer1
{
        ...
        public override bool PreAI()
        {
			...
			if (!Main.npc[(int)NPC.ai[1]].active)
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    (int)NPC.Center.Y + (NPC.height / 2), ModContent.NPCType<BoneStackerMoving1>(), NPC.whoAmI);
    ...
    public class BoneStackerMoving1 : ModNPC
    {
        public override string Texture => "Spooky/Content/NPCs/Catacomb/Layer1/BoneStacker1";
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) 
        {
            ...
            {
				new FlavorTextBestiaryInfoElement("Mods.Spooky.Bestiary.BoneStacker1"),
