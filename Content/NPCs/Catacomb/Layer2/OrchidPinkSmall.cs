...
{
    public class OrchidPinkSmall : ModNPC  
    {
        int MoveSpeedX;
        int MoveSpeedY;
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "Spooky/Content/NPCs/NPCDisplayTextures/OrchidPinkSmallBestiary",
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) 
        {
            ...
            {
				new FlavorTextBestiaryInfoElement("Mods.Spooky.Bestiary.OrchidPinkSmall"),
        ...
        public override void AI()
		{
            ...
            if (Parent.active && Parent.type == ModContent.NPCType<OrchidStem>())
            {
                ChasePlayer(player, Parent, 2, 0.01f);
            }
        }
        ...
        public override void HitEffect(NPC.HitInfo hit) 
        {
            if (NPC.life <= 0) 
            {
                for (int numGores = 1; numGores <= 5; numGores++)
                {
                    ...
                    {
                        Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModContent.Find<ModGore>("Spooky/OrchidPinkSmallGore" + numGores).Type);
                    }
                }
