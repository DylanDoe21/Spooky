...
{
    public class MistGhostSwirl : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            {
                new FlavorTextBestiaryInfoElement("Mods.Spooky.Bestiary.MistGhostSwirl"),
        ...
        public override void AI()
		{
            ...
            else
            {
                ...
                if (NPC.ai[2] == 120)
                {
                    SavePosition = NPC.Center - (NPC.Center.X < player.Center.X ? new Vector2(-35, 0) : new Vector2(35, 0));
                }
                ...
                if (NPC.ai[2] > 120)
                {
                    ...
                    NPC.ai[3] = Math.Sign(angle);
                    NPC.velocity = Vector2.Normalize(NPC.velocity) * 8;

                    NPC.velocity = NPC.velocity.RotatedBy(MathHelper.ToRadians(3f) * NPC.ai[3]);
                }
